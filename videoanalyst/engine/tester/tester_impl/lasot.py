...
class LaSOTTester(TesterBase):
    ...
    extra_hyper_params = dict(
        device_num=2,
        data_root="/media/ubuntu/dataset_nvme/object_tracking/LaSOT/test",
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            dataset_name = "LaSOT-Benchmark"  # the name of benchmark toolkit, shown under "repo/logs" directory
