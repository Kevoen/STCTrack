...
class UAVTester(TesterBase):
    ...
    extra_hyper_params = dict(
        device_num=1,
        data_root="/media/ubuntu/dataset/object_tracking/UAV123-1/UAV123",
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            dataset_name = "UAV-Benchmark"  # the name of benchmark toolkit, shown under "repo/logs" directory
