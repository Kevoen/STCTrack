...
class OTBTester(TesterBase):
    ...
    extra_hyper_params = dict(
        device_num=2,
        data_root="/media/ubuntu/dataset/object_tracking/OTB2015",
        subsets=["otb2015"],  # (2013|2015)
    )
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            dataset_name = "OTB-Benchmark"  # the name of benchmark toolkit, shown under "repo/logs" directory
