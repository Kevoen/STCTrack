...
class TrackingNetTester(TesterBase):
    ...
    extra_hyper_params = dict(
        device_num=2,
        data_root="/media/ubuntu/dataset_nvme/object_tracking/TrackingNet",
    ...
    def test(self, ):
        ...
        for subset in self._hyper_params["subsets"]:
            ...
            dataset_name = "TrackingNet-Benchmark"  # the name of benchmark toolkit, shown under "repo/logs" directory
